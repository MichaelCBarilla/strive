...
class _$AppStateCopyWithImpl<$Res, $Val extends AppState>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      selectedPageIndex: null == selectedPageIndex
...
class _$AppStateImpl implements _AppState {
  const _$AppStateImpl({required this.selectedPageIndex});
  ...
  @override
  String toString() {
    return 'AppState(selectedPageIndex: $selectedPageIndex)';
  }
...
abstract class _AppState implements AppState {
  const factory _AppState({required final int selectedPageIndex}) =
      _$AppStateImpl;
